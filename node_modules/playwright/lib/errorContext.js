...
async function loadSource(errorLocation, testLocation, sourceCache) {
  if (errorLocation) {
    const source2 = await loadSourceCached(errorLocation.file, sourceCache);
    if (source2)
      return { location: errorLocation, source: source2 };
  }
...
async function loadSourceCached(file, sourceCache) {
