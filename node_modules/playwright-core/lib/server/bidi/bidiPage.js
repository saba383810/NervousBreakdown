...
__export(bidiPage_exports, {
  BidiPage: () => BidiPage,
  addMainBindingSource: () => addMainBindingSource,
...
const addMainBindingSource = `function addMainBinding(callback) { globalThis['${import_javascript.kPlaywrightBinding}'] = callback; }`;
