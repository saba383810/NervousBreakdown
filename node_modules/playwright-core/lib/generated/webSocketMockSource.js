...
function inject(globalThis2) {
  ...
  const _WebSocketMock = class _WebSocketMock extends EventTarget {
    constructor(url, protocols) {
      ...
      this._origin = (_b15 = (_a15 = URL.parse(this.url)) == null ? void 0 : _a15.origin) != null ? _b15 : "";
    ...
    _ensureOpened() {
      ...
      if (this.readyState !== _WebSocketMock.CONNECTING)
        return;
      this.extensions = ((_a15 = this._ws) == null ? void 0 : _a15.extensions) || "";
      if (this._ws)
